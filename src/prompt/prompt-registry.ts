...
const PROMPT_DEFINITIONS: PromptDefinition[] = [
  ...
  {
    key: 'runner.base.codex_scheduled_lightweight',
    featureScope: 'runner',
    title: 'Runner Codex scheduled lightweight base policy',
    description: 'Lightweight Codex system prompt prefix for scheduled task execution.',
    promptKind: 'system',
    layer: 'system_base',
    mutability: 'parameterized',
    defaultTemplate: [
      ...
      'Use available tools only when they materially help complete the task.',
      'Working directory: {{projectDir}}',
    ].join('\n'),
    variables: ['projectDir'],
  },
  ...
  {
    key: 'runner.base.claude_scheduled_lightweight',
    featureScope: 'runner',
    title: 'Runner Claude scheduled lightweight base policy',
    description: 'Lightweight Claude system prompt prefix for scheduled task execution.',
    promptKind: 'system',
    layer: 'system_base',
    mutability: 'runtime_fixed',
    defaultTemplate: [
  ...
  {
    key: 'runner.task.scheduled_execution',
    featureScope: 'runner',
    title: 'Runner scheduled task execution hint',
    description: 'Minimal behavior hint for scheduled task execution payloads.',
    promptKind: 'instruction',
    layer: 'system_policy',
    mutability: 'configurable',
    defaultTemplate: [
      'This run was triggered by an existing scheduled task.',
      'Focus on carrying out the task content itself.',
      'Do not talk about reminder setup, task creation, scheduling metadata, or automation status unless the task explicitly asks for those details.',
    ].join('\n'),
    variables: [],
  },
  {
