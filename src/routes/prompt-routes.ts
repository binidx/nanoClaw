      ...
      if (mode === 'conversation') {
        ...
        res.json({
          ...
          preview: buildPromptPreviewEnvelope({
            ...
            chatJid,
            stableSystemPrompt: envelope.compiledPrompt.stableSystemPrompt,
            volatileSystemPrompt: envelope.compiledPrompt.volatileSystemPrompt,
            systemPromptText: envelope.compiledPrompt.systemPromptText || null,
            userPromptText: envelope.compiledPrompt.userPrompt,
            providerInputText: envelope.compiledPrompt.providerInputText || envelope.prompt.text,
            contextBlocks: envelope.compiledPrompt.contextBlocks,
            segments: envelope.segments,
            resolution: envelope.resolution,
            stablePrefixFingerprint: envelope.compiledPrompt.stablePrefixFingerprint || null,
            cacheFingerprint: envelope.compiledPrompt.cacheFingerprint || null,
            metadata: {
