...
export type SettingsExtensionsTabProps = {
  ...
  >;
  refreshMarketplaceCatalog: (input?: {
...
export function SettingsExtensionsTab(
  props: SettingsExtensionsTabProps & {
    variant?: SettingsExtensionsTabVariant;
  },
) {
  ...
  const renderExtensionMarketplaceSection = () => (
    <div className="settings-section extensions-panel extensions-panel-skills">
      ...
      <details className="settings-advanced-block extensions-action-block" open>
        <summary className="settings-advanced-summary">
          <span className="settings-advanced-title">
            {t('settings.extensions.1ffbe4')}
          </span>
        ...
        <div className="settings-advanced-content">
          <div className="channel-instance-list extensions-skills-list">
            {marketplaceDraft.map((entry) => {
              const sourceMeta = entry as ExtensionMarketplaceSourceDraft & {
                origin?: string;
                readOnly?: boolean;
              };
              const isReadOnlyLegacySource = sourceMeta.readOnly === true;
              return (
                <div
                  key={entry.draftKey}
                ...
                >
                  <div className="extensions-meta-row">
                    ...
                    {isReadOnlyLegacySource ? (
                      <span className="extensions-chip muted">
                        legacy read-only
                      </span>
                    ) : null}
                    {!entry.persistedId ? (
                      <span className="extensions-chip warning">
                        {t('settings.extensions.39ef65')}
                      </span>
                    ) : null}
                    {isMarketplaceSourceDraftDirty(entry) ? (
                      <span className="extensions-chip warning">
                        {t('settings.extensions.48b4cc')}
                      </span>
                    ) : (
                      <span className="extensions-chip success">
                        {t('settings.extensions.16c65e')}
                      </span>
                    )}
                    {entry.enabled === false ? (
                      <span className="extensions-chip muted">
                        {t('settings.extensions.1c1ed9')}
                      </span>
                    ) : null}
                  </div>
                  <div className="channel-instance-grid">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        disabled={savingSkillsConfig || isReadOnlyLegacySource}
                    ...
                    {renderBooleanField(
                      ...
                      savingSkillsConfig || isReadOnlyLegacySource,
                    )}
                  </div>
                  <div className="modal-actions">
                    <button
            ...
            {marketplaceDraft.length === 0 && (
              <div className="provider-empty">
                {t('settings.extensions.e435be')}
              </div>
            )}
          </div>
          <div className="settings-hint">{t('settings.extensions.92416b')}</div>
          <div className="modal-actions">
            <button
            ...
            >
              {savingSkillsConfig
                ? t('settings.extensions.保存中')
                : t('settings.extensions.auto_be5fbb')}
            </button>
          </div>
        </div>
      </details>
      ...
      <details className="settings-advanced-block extensions-action-block">
        ...
        <div className="settings-advanced-content">
          ...
          <div className="modal-actions">
            ...
            >
              {extensionActionStatus?.importing
                ? t('settings.extensions.fb905a')
                : savingSkillsConfig
                  ? t('settings.extensions.7fc54d')
                  : t('settings.extensions.207c6c')}
            </button>
          </div>
        </div>
      </details>
      ...
      <div className="settings-section">
        <div className="section-header">
          <div>
            ...
            <p className="settings-hint">{t('settings.extensions.0db066')}</p>
          </div>
        </div>
        {marketplaceCatalogMessage ? (
          <div
            ...
            <div key={group.key} className="extensions-marketplace-group">
              <div className="channel-instance-summary-main">
                ...
                <div className="extensions-summary-text">
                  {t('settings.extensions.entryCount', {
                    ...
                    <div className="extensions-entry-meta">
                      ...
                      >
                        {entry.installSourceId
                          ? t('settings.extensions.7e3777')
                          : t('settings.extensions.6e3fab')}
                      </span>
                      {!entry.installable ? (
                        ...
                        onClick={() =>
                          void installMarketplaceExtension({
                            ...(entry.installSourceId
                              ...
                              : {
                                  source:
                                    entry.installSource || entry.sourceLabel,
                                }),
      ...
      <div className="settings-section">
        <div className="section-header">
          <div>
            ...
            <p className="settings-hint">{t('settings.extensions.6ed367')}</p>
          </div>
          <button
            type="button"
            className="btn-outline btn-sm"
          ...
          >
            {extensionActionStatus?.reconciling
              ? t('settings.extensions.4996ad')
              : t('settings.extensions.d75842')}
          </button>
        </div>
        <div className="channel-instance-list extensions-skills-list">
            ...
            >
              <div className="channel-instance-summary-main">
                ...
                <div className="extensions-summary-text">
                  ...
                  {entry.installedMcpServerIds.length} · Agents{' '}
                  {entry.agentCount}
                </div>
                <div className="extensions-detail-block">
                  <div className="extensions-detail-label">
                    {t('settings.extensions.1e4414')}
                  </div>
              ...
              <div className="channel-instance-summary-side">
                ...
                >
                  {entry.status === 'needs_attention'
                    ? t('settings.extensions.0cc14d')
                    : t('settings.extensions.31ee39')}
                </span>
                <button
                  type="button"
                  className="btn-danger btn-sm"
    ...
    <div className="settings-section extensions-panel extensions-panel-mcp">
      <div className="section-header">
        <div>
          ...
          <p className="settings-hint">{t('settings.extensions.b28469')}</p>
        </div>
        <button
          type="button"
          className="btn-primary btn-sm"
      ...
      <details className="settings-advanced-block extensions-action-block">
        <summary className="settings-advanced-summary">
          <span className="settings-advanced-title">
            {t('settings.extensions.从本地路径安装_MCP')}
          </span>
          <span className="settings-advanced-meta">
      ...
      <details className="settings-advanced-block extensions-action-block">
        <summary className="settings-advanced-summary">
          <span className="settings-advanced-title">
            {t('settings.extensions.从_JSON_导入_MCP')}
          </span>
          <span className="settings-advanced-meta">
...
"mcpServers": {
              ...
              >
                <summary className="channel-instance-summary">
                  ...
                  <div className="channel-instance-summary-side">
                    ...
                    >
                      {server.enabled
                        ? t('settings.subagent.已启用')
                        : t('settings.extensions.已关闭')}
                    </span>
                    <span className="extensions-summary-meta">
    ...
    <div className="settings-section extensions-panel extensions-panel-skills">
      <div className="section-header">
        <div>
          ...
          <p className="settings-hint">{t('settings.extensions.8e6911')}</p>
        </div>
        {openCommandGuideChat ? (
          <button
            type="button"
      ...
      <details className="settings-advanced-block extensions-action-block">
        <summary className="settings-advanced-summary">
          <span className="settings-advanced-title">
            {t('settings.extensions.从本地目录安装_Skill')}
          </span>
          <span className="settings-advanced-meta">
            ...
            >
                ...
                <div className="channel-instance-summary-main">
                  ...
                  <div className="settings-hint">
                    ...
                    {skill.source === 'builtin'
                      ? t('settings.extensions.auto_89e180')
                      : t('settings.extensions.d95144')}
                  </div>
                  <div className="extensions-summary-text">
              ...
              <div className="channel-instance-content">
                <div className="channel-instance-grid">
                  ...
                  <div className="form-group">
                    ...
                    <textarea
                      rows={3}
                      value={
                        skill.description || t('settings.extensions.5b9801')
                      }
                      disabled
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <textarea
                      ...
                      value={
                        detail?.dirPath ||
                        (loading ? t('settings.extensions.0a0a2f') : '')
                      }
                      disabled
                    />
                  </div>
                ...
                {detail?.summary ? (
                  <div className="extensions-detail-block">
                    <div className="extensions-detail-label">
                      {t('settings.extensions.SKILL_摘要')}
                    </div>
                    <div className="extensions-detail-text">
                      {detail.summary}
                    </div>
  ...
  const extensionsFeedback = extensionsMessage ? (
    <div
